...
var ReactMic = function (_PureComponent) {
  ...
  function ReactMic(props) {
    ...
    _this.visualize = function () {
      ...
      if (!record) {
        _Visualizer2.default.stopVisualization(canvasCtx, canvas, width, height, backgroundColor, strokeColor);
        return;
      }
      if (visualSetting === 'sinewave') {
        _Visualizer2.default.visualizeSineWave(analyser, canvasCtx, canvas, width, height, backgroundColor, strokeColor, fps);
